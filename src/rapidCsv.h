...
namespace rapidcsv
{
  ...
  public:
     ...
     * @details Returns full set of data. It is a read-only reference to low internal storage. 
     * It's up to the user access data with correct indices
     * @returns vector of row names.
     */
    const std::vector<std::vector<std::string>>& GetRawData() const
    {
        return mData;
    }
